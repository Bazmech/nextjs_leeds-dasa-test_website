...
// Parking to riverbank distances (in metres, or 0 for "on bank")
export const parkingDistances = {
  // River Aire
  "aire-beal": { distance: 50, note: null },
  "aire-ferrybridge": { distance: 300, note: null },
  "aire-stockbridge": { distance: 100, note: null },
  "aire-chapel-haddlesey": { distance: 0, note: "Park on bank" },
  "aire-west-haddlesey": { distance: 0, note: "Park on bank" },
  
  // River Derwent
  "derwent-kexby": { distance: 150, note: null },
  "derwent-sutton": { distance: 50, note: null },
  
  // River Nidd
  "nidd-hammerton": { distance: 575, note: "Feels further!" },
  "nidd-moor-monkton": { distance: 100, note: null },
  "nidd-skip-bridge": { distance: 50, note: "Both above and below bridge" },
  
  // River Ouse
  "ouse-hunters-lodge": { distance: 75, note: null },
  "ouse-linton": { distance: 50, note: null },
  
  // River Swale
  "swale-asenby": { distance: 150, note: null },
  "swale-helperby": { distance: 425, note: null },
  "swale-myton": { distance: 225, note: null },
  "swale-pickhill": { distance: 900, note: "Longest walk - worth it!" },
  
  // River Ure
  "ure-aldwark-bridge": { distance: 50, note: null },
  "ure-aldwark-left-bank": { distance: 200, note: "Via pub car park" },
  "ure-lower-dunsforth": { distance: 500, note: null },
  "ure-middleham": { distance: 100, note: null },
  
  // River Wharfe
  "wharfe-easedike": { distance: 175, note: null },
  "wharfe-linton": { distance: 325, note: null },
  "wharfe-kearby": { distance: 475, note: "4x4 recommended for track" },
  "wharfe-pool": { distance: 325, note: null },
  "wharfe-ulleskelf": { distance: 175, note: "Railway field section" },
};