...
export const lakes = [
  ...
  {
    id: "blacker-dam",
    name: "Blacker Dam, Silkstone",
    description:
      "Situated down Blackergreen Lane, Silkstone, near Barnsley. No matches allowed. No carp to be retained in keepnets. Yearbook holders only.",
    image: "/images/lakes/blacker-dam.jpg",
    species: ["Carp", "Tench", "Roach", "Perch", "Pike"],
    facilities: ["Car parking", "Rural location"],
  },
  {
    id: "st-aidans",
    name: "St Aidan's Nature Reserve",
    description:
      "Large open water with excellent specimen fishing potential. Part of an RSPB nature reserve with stunning views and wildlife.",
    image: "/images/lakes/st-aidans.jpg",
    species: ["Carp", "Pike", "Perch", "Bream", "Roach"],
    facilities: ["Car parking", "Nature trails", "Bird watching"],
  },
  {
    id: "yeadon-tarn",
    name: "Yeadon Tarn",
    description:
      "A 7-hectare lake in Yeadon offering excellent coarse fishing with stunning views. Popular venue for all abilities.",
    image: "/images/lakes/yeadon-tarn.jpg",
    species: ["Carp", "Tench", "Bream", "Roach", "Pike"],
    facilities: ["Car parking", "Cafe nearby", "Scenic views"],
  },
  {
    id: "waterloo-lake",
    name: "Waterloo Lake, Roundhay Park",
    description:
      "Located within the beautiful Roundhay Park in Leeds. A popular urban fishery with good stocks of coarse fish.",
    image: "/images/lakes/waterloo-lake.jpg",
    species: ["Carp", "Tench", "Roach", "Perch", "Pike"],
    facilities: ["Park parking", "Cafe nearby", "Toilets"],
  },
  {
    id: "allerton-bywater-pond",
    name: "Allerton Bywater Pond",
    description:
      "A well-stocked pond in the Allerton Bywater area offering good fishing for mixed species.",
    image: "/images/lakes/allerton-bywater.jpg",
    species: ["Carp", "Tench", "Roach", "Perch", "Rudd"],
    facilities: ["Limited parking", "Quiet venue"],
  },
  {
    id: "rothwell-country-park",
    name: "Rothwell Country Park Lake",
    description:
      "Scenic lake within Rothwell Country Park offering peaceful fishing in natural surroundings.",
    image: "/images/lakes/rothwell-country-park.jpg",
    species: ["Carp", "Tench", "Roach", "Perch", "Pike"],
    facilities: ["Car parking", "Nature walks", "Toilets"],
  },
  {
    id: "temple-newsam",
    name: "Temple Newsam Lake",
    description:
      "Historic lake in the grounds of Temple Newsam House offering coarse fishing in beautiful surroundings.",
    image: "/images/lakes/temple-newsam.jpg",
    species: ["Carp", "Tench", "Bream", "Roach", "Perch"],
    facilities: ["Estate parking", "Historic house", "Cafe"],
  },
  {
    id: "swillington-pond",
    name: "Swillington Pond",
    description:
      "A peaceful pond near Swillington village with good stocks of mixed coarse fish.",
    image: "/images/lakes/swillington.jpg",
    species: ["Carp", "Tench", "Roach", "Rudd", "Perch"],
    facilities: ["Limited parking", "Village location"],
  },
];
